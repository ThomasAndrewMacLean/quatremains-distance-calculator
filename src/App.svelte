...
<div class="container">
  <header>
    ...
    <h4>
      {labels.subtitle || 'FILL IN THIS FORM TO GET AN APPROXIMATION OF THE PRICE'}
    </h4>
  </header>
    ...
    <form on:submit={submit}>
      ...
      <div class="input-row">
        <div class="input-wrap date-input">
          ...
          <input bind:value={date} name="date" type="date" id="date" required />
          {#if dateReserved.includes(date)}
            <span class="warning">Piano not available on this date</span>
          {/if}
        </div>
      ...
      {#if partOneOfFormComplete}
        ...
        <div class="input-row">
          <div class="input-wrap">
            ...
            <input name="telephone" type="telephone" id="telephone" required />
          </div>
